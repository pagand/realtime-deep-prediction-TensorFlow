...
PGender = ['male', 'female']
PRace = [' White', 'Black', 'Asian', 'Indian', 'Others (like Hispanic, Latino, Middle Eastern)']
...
def run(image_aligned):
    with tf.Graph().as_default():
        ...
        logits_gender, logits_race, logits_age, _, _ = build_model(image_aligned, train_mode)
        ...
        pred_gender, pred_race, pred_age = sess.run([gender, race, age], {train_mode: False})

        return pred_gender, pred_race, pred_age
